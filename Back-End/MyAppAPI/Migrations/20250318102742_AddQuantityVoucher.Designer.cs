...
namespace MyAppAPI.Migrations
{
    ...
    [Migration("20250318102742_AddQuantityVoucher")]
    partial class AddQuantityVoucher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebOnline.Models.EF.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Address = "VietNam",
                            ConcurrencyStamp = "23083492-a284-4331-895c-400bba934fa4",
                            CreatDate = new DateTime(2025, 3, 18, 10, 27, 40, 343, DateTimeKind.Utc).AddTicks(1809),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAENIZj/n4H/0zBWmLlA6MDc5ky91OMUb0mP8beWmZcqeBE5OequCHiYEZUe6DfGbfig==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2f4fe12d-d345-4526-baf6-ecde2735a7fe",
            ...
            modelBuilder.Entity("WebOnline.Models.OrderVoucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOnline.Models.ProductVoucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOnline.Models.UserVoucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOnline.Models.Voucher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebOnline.Models.EF.Products", b =>
                {
                    b.HasOne("WebOnline.Models.EF.Brand", "Branch")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebOnline.Models.OrderVoucher", b =>
                {
                    b.HasOne("WebOnline.Models.EF.Oders", "Order")
                        .WithMany("OrderVouchers")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebOnline.Models.Voucher", "Voucher")
                        .WithMany("OrderVouchers")
            ...
            modelBuilder.Entity("WebOnline.Models.ProductVoucher", b =>
                {
                    b.HasOne("WebOnline.Models.EF.Products", "Product")
