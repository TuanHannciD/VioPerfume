        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NameProducts = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    CodeProducts = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Origin = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Capacity = table.Column<int>(type: "int", nullable: false),
                    FragranceGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Address", "ConcurrencyStamp", "CreatDate", "DeletedDate", "Email", "EmailConfirmed", "FullName", "IsDeleted", "LockoutEnabled", "LockoutEnd", "ModifiedBy", "ModifiedDate", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "admin-id", 0, "VietNam", "36370177-db91-425c-a1c3-94d15dfb0067", new DateTime(2025, 3, 1, 10, 20, 2, 923, DateTimeKind.Utc).AddTicks(7954), null, "admin@example.com", true, "Administrator", false, false, null, "System", null, "ADMIN@EXAMPLE.COM", "ADMIN@EXAMPLE.COM", "AQAAAAIAAYagAAAAEHhAQsIAbG2jov+NLebdwAhwgTbHhtJKjvoWheNpWv/kc5CBoOHVlxWuS6XbPUbbtw==", null, false, "e1dd702f-2fcf-46fa-a31f-12b6e026da1f", false, "admin@example.com" });
